...
DQNAgent.prototype = {
  reset: function() {
    ...
    this.net = {};
    this.net.W1 = new R.RandMat(this.nh, this.totalStateNum, 0, 0.01);
    this.net.b1 = new R.Mat(this.nh, 1, 0, 0.01);
    this.net.W2 = new R.RandMat(this.totalActionNum, this.nh, 0, 0.01);
    this.net.b2 = new R.Mat(this.totalActionNum, 1, 0, 0.01);
  ...
  toJSON: function() {
    ...
    var j = {};
    j.nh = this.nh;
    j.totalStateNum = this.totalStateNum;
    j.totalActionNum = this.totalActionNum;
  ...
  fromJSON: function(j) {
    // load function
    this.nh = j.nh;
    this.totalStateNum = j.totalStateNum;
    this.totalActionNum = j.totalActionNum;
  ...
  act: function(slist) {
    ...
    // epsilon greedy policy
    if(Math.random() < this.epsilon) {
      var a = randInt(0, this.totalActionNum);
    } else {
